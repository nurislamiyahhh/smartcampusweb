        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="container-fluid" style="padding-top: 1%; text-align: center">
                ...
                <p class="mb-4">Sistem Parkir terintegrasi dapat diakses dengan RFID Card atau menekan tombol dibawah ini</p>
...
<div class="row">
    <div class="col-lg-6" style="padding-top: 0%; text-align: center">
                <div class="my-2"></div>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">Dept Elektro</span></a>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">Student Center</span></a>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">COT</span></a>
            </div>
