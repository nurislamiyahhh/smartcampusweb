        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="admin_tambah_user.php"> <button class="btn btn-primary"><i class="fas fa-user-plus"></i> Mahasiswa</button></a>
                     </div>
                        </div>
                        <div class="card-body">
					...
					include "config.php";
					 ...
					 $no = 1;
                        // Membuat Pagination
                        $banyakdataperhal = 10;
                        $banyakdata = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM datauser"));
                        $banyakhal = ceil($banyakdata / $banyakdataperhal); //ceil berfungsi untuk pembagian bulat

                        $halamanaktif = (isset($_GET['dataTable'])) ? $_GET['dataTable'] : 1;

                        $dataawal = ($halamanaktif * $banyakdataperhal) - $banyakdataperhal;
                         

                        $tampil = mysqli_query($conn, "SELECT * FROM datauser order by no desc LIMIT $dataawal, $banyakdataperhal");
                        
                        //Fitur Search
                        if(isset($_POST['cari'])){
                            $keyword = $_POST['keyword'];
                            $tampil = mysqli_query($conn, "SELECT * FROM datauser WHERE 
                            ...
                            $tampil = mysqli_query($conn, "SELECT * FROM datauser LIMIT $dataawal, $banyakdataperhal");
                        }
				...
				<tr>
					<th scope="row" style="text-align: center;"> <?php echo $no++; ?> </td>
					<td style="text-align: center;"> <?php echo $data['no_id']; ?> </td>
					<td> <?php echo $data['nama']; ?> </td>
					<td style="text-align: center;"> <?php echo $data['nim']; ?> </td>
					<td style="text-align: center;width:16%"> <?php echo $data['prodi']; ?> </td>
					<td style="text-align: center;width:10%">
						<a class="btn btn-success btn-sm" href="admin_edit_user.php"> <i class="fas fa-user-edit"></i></a>    
                        <a class="btn btn-warning btn-sm" href="admin_hapus_user.php"> <i class="fas fa-trash-alt"></i></a>
					</td>
				</tr>
