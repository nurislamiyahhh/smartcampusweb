            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="openparkir.php">Open the Barrier</a>
                        <a class="collapse-item" href="utilities-animation.html">Booking</a>
                        <a class="collapse-item" href="utilities-other.html">Seats</a>
                    </div>
                </div>
            </li>
