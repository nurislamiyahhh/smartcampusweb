    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <!-- Begin Page Content -->
               <div class="container-fluid" style="padding-top: 1%; text-align: center">

                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Attandence System</h1>
                <p class="mb-4">Sistem Absensi terintegrasi dapat diakses dengan RFID Card atau menekan tombol dibawah ini</p>
...
<div class="row">
    <div class="col-lg-6" style="padding-top: 0%; text-align: center">
                <div class="my-2"></div>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">Lab Telkom</span></a>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">Lab Antena</span></a>
                <a href="welcomeroom.php" class="btn btn-primary btn-icon-split btn-lg"><span class="text">Lab Telematika</span></a>
            </div>
