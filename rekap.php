        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Rekapitulasi</h3>
                            <div class="col-md-5">    
                            </div>
                        </div>            
                                <div class="card-body">
				...
				<?php
					...
					$sql = mysqli_query($conn, "SELECT nama, NIM, Tanggal, Jam_Masuk, Jam_Keluar FROM rekap, datauser  WHERE no_id=no_id and Tanggal='$tanggal'");
				...
				<tr>
					...
					<td style="text-align: center">
						<a class="btn btn-warning btn-sm" href="rekap.php?hal=hapus&id=<?=$data['no']?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')"> <i class="fas fa-trash-alt"></i> </a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
