...
<body id="page-top">
	...
	if(isset($_POST['btnSimpan']))
	{
		...
		$simpan = mysqli_query($conn, "INSERT INTO datauser(nama, nim, prodi) VALUES ('$nama', '$nim', '$prodi')");
...
<div class="container">
	...
	<div class="col-sm-9" style="margin:0 auto;">
	  <h3 style="margin-top:2%;text-align: center;">Tambah Data Mahasiwa</h3>
	  <div class="card">
  		<div class="card-body">
		<!-- form input -->
		<form method="POST">
			...
			<div class="form-group">
				...
				<input type="text" name="nama" id="nama" placeholder="Input Nama Mahasiswa" class="form-control">
			</div><br>
			<div class="form-group">
                <label>NIM</label>
            ...
            <a class="btn btn-danger" href="datauser">Batal</a>
                  </form>  
		</form>
	  </div>
	  </div>
